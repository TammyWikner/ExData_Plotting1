#
# plot3.R - Written for the Coursera Exploratory Data Analysis Week 1 
# 			Project Assignment. 
#
# Assignment - Given a picture of plot 3, construct a plot to look like the 
...
#   2) Save and source plot3.R in your working directory
#
# Ouput:
#	plot3.png file written to your working directory
#
#	Dataset Info:
...
plot3 <- function(){
	...
	# Make lines plot showing three lines for each of the 
	# sub_metering_# active energy usage. Line 1 is the default color 
	# blank, line 2 is red, and line 3 is blue.
	...
	# Annotate the plot with the a legend in the top righthand corner of 
	# the plot.
