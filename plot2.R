#
# plot2.R - Written for the Coursera Exploratory Data Analysis Week 1 
# 			Project Assignment. 
#
# Assignment - Given a picture of plot 2, construct a plot to look like the 
...
#   2) Save and source plot2.R in your working directory
#
# Ouput:
#	plot2.png file written to your working directory
#
#	Dataset Info:
...
plot2 <- function(){
	...
	# Make lines plot showing the global minute-averaged 
	# active power usage, with appropriate y axis labels.  
	with(powerConsumption, plot(Global.Active.Power, type="l", ylab="Global Active Power (kilowatts)", xlab="", xaxt="n"))

	# Annotate the plot with specific tick mark locations and tick mark 
